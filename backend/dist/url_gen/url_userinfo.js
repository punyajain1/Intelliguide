...
exports.URL_gen_userinfo = void 0;
const crypto = __importStar(require("crypto"));
const URL_gen_userinfo = (userHandle) => {
    const baseUrl = `https://codeforces.com/api/user.info`;
    const apiKey = process.env["UINFO_API"];
    const secret = process.env["UINFO_SEC"];
...
exports.URL_gen_userinfo = URL_gen_userinfo;
